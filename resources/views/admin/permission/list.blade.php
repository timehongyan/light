...
<div class="mws-panel grid_8">
    ...
    <div class="mws-panel-body no-padding">
        <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper" role="grid">
			...
			<form action="/admins/permission" method='get'>
                ...
                @foreach($rs as $k => $v)
                	...
                	@endif
                        ...
                        <td class=" ">
                            ...
                            <a class='btn btn-warning' href="/admins/permission/{{$v->id}}/edit">修改</a>


                            <form action="/admins/permission/{{$v->id}}" method='post' style='display: inline'>
                                {{csrf_field()}}
                                {{method_field('DELETE')}}
